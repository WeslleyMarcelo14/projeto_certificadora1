  ...
  return (
    <main className="h-screen flex items-center justify-center bg-softPink p-10">
      <div className="grid w-full h-full grid-cols-1 md:grid-cols-2 bg-lightPink">
        ...
        <section className="flex flex-col items-center justify-center bg-mediumPink text-softPink p-6">
        ...
        <section className="relative hidden md:block">
          <Image className="object-cover" fill src="/bg.jpg" alt="Imagem de fundo relacionada ao projeto" />
        </section>
      </div>
    </main>
  );
